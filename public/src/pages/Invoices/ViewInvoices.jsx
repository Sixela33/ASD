        ...
        <div className='container mx-auto pt-12 p-4 text-center page'>
            ...
            <div className='m-2 text-left flex items-center space-x-4 justify-evenly'>
                ...
                <div className='flex flex-col w-full items-center space-x-1'>
                    ...
                    <div className='flex flex-row'>
                        <input className='w-1/2 no-spinner' type='number' value={minAmount} onChange={(e) => setMinAmmount(e.target.value)} />
                        <input className='w-1/2 no-spinner' type='number' value={maxAmount} onChange={(e) => setMaxAmmount(e.target.value)} />
                    </div>
                </div>
