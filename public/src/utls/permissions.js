...
export const permissionsRequired = {
    ...
    'veiw_project_statistics': ROLES_LIST['Staff'],

    'create_new_flower': ROLES_LIST['Admin'],
    'create_new_project': ROLES_LIST['Admin'],
    'create_new_invoice': ROLES_LIST['Admin'],
    'delete_project':ROLES_LIST['Admin'],

    'edit_invoice': ROLES_LIST['Admin'],
    'edit_arrangement': ROLES_LIST['Staff'],
    'add_arrangement': ROLES_LIST['Staff'],
    ...
    'download_projectppt': ROLES_LIST['Staff'],
}
