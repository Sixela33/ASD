...
const arrangements = [
    { arrangementType: 'Type1', arrangementDescription: 'Description1', flowerBudget: 100, arrangementQuantity: 5 },
    { arrangementType: 'Type2', arrangementDescription: 'Description2', flowerBudget: 150, arrangementQuantity: 3 },
    { arrangementType: 'Type3', arrangementDescription: 'Description3', flowerBudget: 120, arrangementQuantity: 4 }
];

const projects = [
    { staffBudget: 2000, projectContact: 'Contact1', projectDate: '2024-01-16', projectDescription: 'Project1', projectClient: 'Client1', profitMargin: 0.2, creatorid: 1 },
    { staffBudget: 2500, projectContact: 'Contact2', projectDate: '2024-01-17', projectDescription: 'Project2', projectClient: 'Client2', profitMargin: 0.15, creatorid: 1 },
    { staffBudget: 1800, projectContact: 'Contact3', projectDate: '2024-01-18', projectDescription: 'Project3', projectClient: 'Client3', profitMargin: 0.18, creatorid: 1 }
];
